    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'five']); ?>" class="router-link-exact-active selected">合肖</a> |
                    ...
                    <div class="cont-main active">
                        <div class="cont-col3">
                            <div class="u-header play_tab_1 clearfix">
                                <div class="fl"><span id="page_game_name">香港六合彩</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span id="page_name">合肖</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
                                当前彩种输赢：<span id="total_sum_money">0.000</span></span></div> <div class="fr"><span id="next_turn_num">2018006</span>&nbsp;期 距离封盘：
                                <span id="bet-date">1天 11:10:16</span> 距离开奖：
                                <span id="open-date">1天 11:15:16</span>
                                </div>
                            </div>
                            <div>
                                        ...
                                        <div class="cont-col3-bd">
                                            <table class="u-table2 play_tab_88">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="not-event">
                                                        <span class="c-txt3" id="oddsSpan">--</span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                            <table class="u-table2 mt10" id="changeTab" data-target-type="26" data-target-num="合肖中">
                                                <thead>
                                                <tr>
                                                    <th>生肖</th>
                                                    <th>号码</th>
                                                ...
                                                <tr data-target-type="26" data-target-num="合肖中" data-target-limit="<?php echo bcadd(count(explode(',',$rule_data['hxz'][0][0]['rate'])),1,0); ?>" data-target-odds="<?php echo $rule_data['hxz'][0][0]['rate']; ?>">
...
<script type="text/javascript">
    $(function(){
        ...
        $(".checkbox_td input").change(function () {
           var count = $("#changeTab .checkbox_td input:checked").length;
           var odds = $(this).parent().attr('data-odds');
           var oddsA = odds.split(',');
           var limit = oddsA.length;
           if(count>limit){
                $(this).prop('checked',false);
                pop('最多可选'+limit+'个');
           }
           $("#oddsSpan").text(oddsA[count-2]);
        })
    })
</script>
</body>
