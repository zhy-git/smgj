<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/smgj/public/../app/home/view/report/openresult.html";i:1540533307;}*/ ?>
<html>
<head>
...
<div id="subpage" class="cp-box2" style="width: 1000px;height: 1000px;" style="display: block;">
	<div>
		<select id="historyQueryParamGameId">
			...
			<option value="<?php echo $cll['id']; ?>"><?php echo $cll['name']; ?></option>
...
<script>
	function getData(page){
        if(page){
            ...
            var url = "<?php echo url('Report/openResult?page=1'); ?>";
        }
            ...
            success: function(n) {
                ...
                if (n.data != null) {
                    ...
                    if (cate == 3 || cate == 4){
                        ...
                        str += '<thead>';
                        str += '<tr><th style="width: 100px" rowspan="2">期数</th><th style="width: 100px" rowspan="2">开奖时间</th><th colspan="3">开出号码</th><th rowspan="2">总和</th><th rowspan="2">大小</th><th rowspan="2">单双</th><th rowspan="2">极值</th></tr><tr><th>第1球</th><th>第2球</th><th>第3球</th></tr>';
                        str += '</thead><tbody>';
                        $.each(n.data.data,function(k,v){
                            var numArr = v.number.split(',');
                            var totalNum = parseInt(numArr[0])*1+parseInt(numArr[1])*1+parseInt(numArr[2])*1;
    ...
    var end = laydate.render({
        ...
        type:'date',
            ...
            getData("<?php echo url('Report/openResult?page=1'); ?>");
        }
    });
    function p(s) {
        return s < 10 ? '0' + s: s;
