    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'eight']); ?>" class="router-link-exact-active selected">正码特</a> |
                    ...
                    <div class="cont-col3">
                        <div class="u-header play_tab_1 clearfix">
                            <div class="fl">
                                ...
                                <span id="page_name">正码特</span>
                                <!--<span id="total_sum_money_text"> &nbsp;&nbsp; 当前彩种输赢：<span id="total_sum_money">0.000</span></span>-->
                            </div>
                            <div class="fr">
                                <span id="next_turn_num">2018006</span>&nbsp;期 距离封盘：
                                <span id="bet-date">1天 11:06:52</span> 距离开奖：
                                <span id="open-date">1天 11:11:52</span>
                            </div>
                        </div>
                        <div>
                                ...
                                <div>
                                    ...
                                    <ul class="tab" style="height: 35px;">
                                        <li class="tab_title02">
                                            ...
                                            <a href="javascript:void(0)" class="<?php echo !empty($k) && $k==1?'on':''; ?>" data-id="<?php echo $vo['type']; ?>"><?php echo $vo['title']; ?></a>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </li>
                                    </ul>
                                    <div id="changeTab">
                                    <table class="u-table2">
                                        ...
                                        <?php if(is_array($rule_data['zmsz']) || $rule_data['zmsz'] instanceof \think\Collection || $rule_data['zmsz'] instanceof \think\Paginator): $k = 0; $__LIST__ = $rule_data['zmsz'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
