    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'sixteen']); ?>" class="router-link-exact-active selected">连肖</a> |
                                ...
                                <div>
                                    <div class="cont-col3-bd">
                                        ...
                                        <table class="u-table2" id="changeTab">
                                            ...
                                            <?php if(is_array($rule_data['sx']) || $rule_data['sx'] instanceof \think\Collection || $rule_data['sx'] instanceof \think\Paginator): $k = 0; $__LIST__ = $rule_data['sx'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
