<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/www/wwwroot/smgj/public/../app/admin/view/operation/qrcode_edit.html";i:1538190012;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                ...
                <div class="panel-body">
                    <div class="form">
                        <form class="form-horizontal adminex-form userForm"  method="post" action="<?php echo url('operation/qrcode_edit'); ?>">
                            ...
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">收款人</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="sha1" value="<?php echo $data['sha1']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">账号</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="path" value="<?php echo $data['path']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">开户行</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="pic" value="<?php echo $data['pic']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">开户网点</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="picd" value="<?php echo $data['picd']; ?>" type="text" />
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-6">
                                    <p class="bor_b left mg_tb10">
                                        <img height="150px"  src="<?php echo $data['qrcode']; ?>"/><br />
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="radio" name="type"  value="4" <?php if($data['type']==4): ?> checked <?php endif; ?>>财付通
                                    <input type="radio" name="type"  value="3" <?php if($data['type']==3): ?> checked <?php endif; ?>>银行转账
                                </div>
                            </div>
                            <div class="form-group">
