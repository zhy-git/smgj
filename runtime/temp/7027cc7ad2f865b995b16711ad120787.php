<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:57:"/www/wwwroot/smgj/public/../app/home/view/xyft/three.html";i:1540433807;s:64:"/www/wwwroot/smgj/public/../app/home/view/common/detail_top.html";i:1539765119;s:62:"/www/wwwroot/smgj/public/../app/home/view/common/cate_top.html";i:1540435336;s:62:"/www/wwwroot/smgj/public/../app/home/view/common/siderbar.html";i:1539588229;s:63:"/www/wwwroot/smgj/public/../app/home/view/xyft/integration.html";i:1523368392;s:64:"/www/wwwroot/smgj/public/../app/home/view/xyft/integration2.html";i:1523368392;s:60:"/www/wwwroot/smgj/public/../app/home/view/common/footer.html";i:1540262035;s:54:"/www/wwwroot/smgj/public/../app/home/view/xyft/js.html";i:1540453519;}*/ ?>
<!DOCTYPE html>
<head>
...
<div class="menu3"><a href="<?php echo url('Index/index'); ?>" class="logout">首页</a></div>
	...
	<div class="header-bottom sub">
		<div class="show cate_menu">
			<a href="<?php echo url('index',['cate'=>7,'hall'=>$hall]); ?>" class="">两面盘</a> |
			<a href="<?php echo url('index',['cate'=>7,'hall'=>$hall,'type'=>'two']); ?>" class="">单号1~10</a> |
			<a href="<?php echo url('index',['cate'=>7,'hall'=>$hall,'type'=>'three']); ?>" class="router-link-exact-active selected">冠亚组合</a>
			<?php if($hall==1): ?>
			<a href="<?php echo url('index',['cate'=>7,'hall'=>2]); ?>" style="padding:2px 5px;background: green;border-radius: 5px;color: #fff;">切换B盘</a>
			<?php else: ?>
			<a href="<?php echo url('index',['cate'=>7,'hall'=>1]); ?>" style="padding:2px 5px;background: green;border-radius: 5px;color: #fff;">切换A盘</a>
			<?php endif; ?>
		</div>
	</div>
					...
					<div class="cont-main active">
						<div class="cont-col3">
							<div class="u-header play_tab_1 clearfix">
								<div class="fl">
									<span id="page_game_name">幸运飞艇</span>&nbsp;&nbsp;-&nbsp;&nbsp;
...
<script>
    ...
    var timeCountDown = {
        ...
        getTime:function (s,n) {
            $.ajax({
                url: "<?php echo url('Xyft/getStage'); ?>",
                type: 'POST',
                dataType: "json",
        ...
        longPolling:function (stage) {
            ...
            $.ajax({
                url: "<?php echo url('Api/checkOpenXyft'); ?>",
                data: {stage: stage},
                type: 'POST',
                dataType: "json",
                timeout: 20000,//20秒超时，可自定义设置
