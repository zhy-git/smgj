    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'fifteen']); ?>" class="router-link-exact-active selected">自选不中</a> |
        ...
        <div class="content-wrap">
            <div class="content">
                ...
                <div class="cont-main active">
                    <div class="cont-col3">
                        <div class="u-header play_tab_1 clearfix"><div class="fl"><span id="page_game_name">香港六合彩</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span id="page_name">自选不中</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
                                当前彩种输赢：<span id="total_sum_money">0.000</span></span></div> <div class="fr"><span id="next_turn_num">2018006</span>&nbsp;期 距离封盘：
                            <span id="bet-date">1天 11:03:32</span> 距离开奖：
                            <span id="open-date">1天 11:08:32</span></div></div>
                        <div>
                                ...
                                <div>
                                    <ul class="tab" style="height: 35px;">
                                        <li class="tab_title02" id="changeTitle">
                                            ...
                                            <a href="javascript:void(0)" class="<?php echo !empty($k) && $k==1?'on':''; ?>" data-id="<?php echo $vo['type']; ?>" data-num="<?php echo $vo['rule']; ?>" data-odds="<?php echo $vo['rate']; ?>"><span><?php echo $vo['rule']; ?></span></a>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </li>
                                    </ul>
                                    <div class="cont-col3-bd" id="changeTab">
                                        <table class="u-table2 mt10">
                                            ...
                                            <?php if(is_array($rule_data['zxbz']) || $rule_data['zxbz'] instanceof \think\Collection || $rule_data['zxbz'] instanceof \think\Paginator): $k = 0; $__LIST__ = $rule_data['zxbz'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                                            <tbody id="box_<?php echo $vo['type']; ?>" style="display: <?php echo $k==1?'inline_block':'none'; ?>">
                                            <?php $__FOR_START_1029228738__=1;$__FOR_END_1029228738__=50;for($j=$__FOR_START_1029228738__;$j < $__FOR_END_1029228738__;$j+=5){ ?>
                                            <tr data-target-type="<?php echo $vo['type']; ?>" data-target-num="<?php echo $vo['rule']; ?>" data-num="<?php echo $i; ?>">
                                                <?php $__FOR_START_1976451371__=$j;$__FOR_END_1976451371__=$j+5;for($i=$__FOR_START_1976451371__;$i < $__FOR_END_1976451371__;$i+=1){ if($i<=49): ?>
                                                <td data-num="<?php echo $i; ?>" data-num="<?php echo str_pad($i,2,'0',STR_PAD_LEFT); ?>" style="width: 60px;min-width: 40px;font-weight: 700;">
                                                    <div class="qiu"><i class="lhc_icon lhc_b<?php echo str_pad($i,2,'0',STR_PAD_LEFT); ?> mr2"><?php echo str_pad($i,2,'0',STR_PAD_LEFT); ?></i></div>
                                                </td>
                                                <td class="odds not-event">
                                                    <span class="c-txt3"><?php echo $vo['rate']; ?></span>
                                                </td>
                                                <td data-num="<?php echo str_pad($i,2,'0',STR_PAD_LEFT); ?>" class="checkbox_td">
                                                    <input type="checkbox" data-num="<?php echo str_pad($i,2,'0',STR_PAD_LEFT); ?>" name="rule_data[]">
                                                </td>
                                                <?php endif; } ?>
                                            </tr>
                                            <?php } ?>
...
<script type="text/javascript">
    $(function(){
        $(".tab_title02 a").click(function(){
            ...
            if(name=="temaA"){
                $(".tab_on_one").find(".odds").children().text(42.25);
            }else{
                $(".tab_on_one").find(".odds").children().text(48.88);
            }
        });
    })
</script>
