<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\money\recharge.html";i:1539658802;s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\base.html";i:1527061064;s:73:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                ...
                <header class="panel-heading col-xs-12 ">
                    <form class="form-inline" action="<?php echo url(''); ?>">
                        <div class="form-group">
                            ...
                            <!--<a href="#"  class="btn btn-success ajax-get" onclick="recharge();"title="后台充值">后台充值</a>-->
                        </div>
                    </form>
                </header>
                    ...
                    <form class="ids" action="<?php echo url('delRecharge'); ?>" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <!--<td>-->
                                    <!--<?php if($v['hui']): ?>-->
                                    <!--<a href="<?php echo url('money/hui',array('id'=>$v['id'])); ?>"  title="查看">查看回执大图</a>-->
                                    <!--<?php else: ?>-->
                                    <!--无-->
                                    <!--<?php endif; ?>-->
            ...
            <form class="form-horizontal form-post-addmoney" action="<?php echo url('addmoney'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="gm_name" id="mobile" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group">
