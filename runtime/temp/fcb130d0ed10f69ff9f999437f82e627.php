    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'seven']); ?>" class="router-link-exact-active selected">正码</a> |
                                ...
                                <div>
                                    ...
                                    <div class="mt10">
                                        <table class="u-table2">
                                            ...
                                            <tbody>
                                            <?php if(is_array($rule_data['zmsz']) || $rule_data['zmsz'] instanceof \think\Collection || $rule_data['zmsz'] instanceof \think\Paginator): $i = 0; $__LIST__ = $rule_data['zmsz'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
