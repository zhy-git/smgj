<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\index\index.html";i:1540374426;s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\base.html";i:1527061064;s:73:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<!--<div class="wrapper">-->
    ...
    <div class="row">
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading col-xs-12 " style="text-align: center">
                        <div class="form-group">
                            <h4 style="text-align: center">今日统计</h4>
                        </div>
                </header>
                <div class="panel-body">
                    <form class="ids" action="<?php echo url(''); ?>" method="post">
                        <table class="table" style="text-align: center;" float="left">
                            <tbody>
                            <tr >
                                <td>总盈利统计</td>
                                <td>用户金额：<?php echo (isset($all['balance']) && ($all['balance'] !== '')?$all['balance']:"0.00"); ?></td>
                                <td>今日盈利：<?php echo (isset($all['win']) && ($all['win'] !== '')?$all['win']:"0.00"); ?></td>
                                <td>昨日盈利：<?php echo (isset($all['win_2']) && ($all['win_2'] !== '')?$all['win_2']:"0.00"); ?></td>
                            </tr>
                            <?php if(is_array($halls) || $halls instanceof \think\Collection || $halls instanceof \think\Paginator): $i = 0; $__LIST__ = $halls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr >
                                <td><?php echo $vo['cate_name']; ?>-<?php echo $vo['name']; ?></td>
                                <td>今日盈亏：<?php echo (isset($vo['win']) && ($vo['win'] !== '')?$vo['win']:"0.00"); ?></td>
                                <td>今日下注数：<?php echo (isset($vo['bet_num']) && ($vo['bet_num'] !== '')?$vo['bet_num']:"0.00"); ?></td>
                                <td>今日下注总额：<?php echo (isset($vo['bet']) && ($vo['bet'] !== '')?$vo['bet']:"0.00"); ?></td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
