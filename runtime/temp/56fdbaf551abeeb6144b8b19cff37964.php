<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/wwwroot/smgj/public/../app/admin/view/lottery/eight_pei.html";i:1540533843;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="adv-table editable-table ">
                            <div> <label class="control-label"><?php echo $cate_name; ?>-->赔率设置(加拿大28 A盘为网盘，B盘为1.85玩法，C盘为1.6玩法赔率)</label></div>
                            ...
                            <!--<table class="table table-striped table-hover table-bordered" id="editable-sample">-->
                                ...
                                <!--<tr>-->
                                    ...
                                    <!--<td>-->
                                        <!--<input type="hidden" class="form-control small" name="id" value="<?php echo $v['id']; ?>">-->
                                        <!--<input type="text" class="form-control small" name="rate" value="<?php echo $v['rate']; ?>">-->
                                    <!--</td>-->
                                    <!--<td>-->
                                        <!--<input type="text" class="form-control small" name="group_rate" value="<?php echo $v['group_rate']; ?>">-->
                                    <!--</td>-->
                                <!--</tr>-->
                                <!--<?php endforeach; ?>-->
                                <!--</tbody>-->
                           ...
                           <!--<?php endif; ?>-->
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tr>
                                    <th>中奖</th>
                                    <th>赔率(A盘)</th>
                                    <th <?php if($cate ==1): ?>style="display:none;"<?php endif; ?>>赔率(B盘)</th>
                                    <th <?php if($cate !=2): ?>style="display:none;"<?php endif; ?>>赔率(C盘)</th>
                                    <th>单注最高</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td <?php if($cate ==1): ?>style="display:none;"<?php endif; ?>>
                                        <input type="text" class="form-control small" name="rate_two[]" value="<?php echo $v['rate_two']; ?>">
                                    </td>
                                    <td <?php if($cate !=2): ?>style="display:none;"<?php endif; ?>>
                                        <input type="text" class="form-control small" name="rate_three[]" value="<?php echo $v['rate_three']; ?>">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control small" name="bet_max[]" value="<?php echo $v['bet_max']; ?>">
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
