<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\lottery\hall_edit.html";i:1539241168;s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\base.html";i:1527061064;s:73:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form">
                        <form class="form-horizontal adminex-form userForm"  method="post" action="<?php echo url('hall_edit'); ?>">
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">大厅名称</label>
                                <div class="col-lg-6">
                            ...
                            <!--<div class="form-group ">-->
                                ...
                                <!--<div class="col-lg-6">-->
                                    <!--<p class="bor_b left mg_tb10">-->
                                        <!--<img height="150px"  src="URL_IMG<?php echo $data['hall_img']; ?>"/><br />-->
                                       ...
                                       <!--<input type="hidden" name="hall_img" value="<?php echo $data['hall_img']; ?>"/>-->
                                        <!--</span>-->
                                    <!--</p>-->
                                <!--</div>-->
                            <!--</div>-->
