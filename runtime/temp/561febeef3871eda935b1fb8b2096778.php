...
<div class="mui-inner-wrap mui-transitioning main">
    <header class="mui-bar mui-bar-nav mui-clearfix">
        ...
        <h1 class="mui-title mui-pull-left">
            <span class="left">重庆时时彩<?php if($hall==1): ?> <a href="<?php echo url('index',['cate'=>3,'hall'=>2]); ?>" class="exchang">切换B盘</a> <?php else: ?> <a href="<?php echo url('index',['cate'=>3,'hall'=>1]); ?>" class="exchang">切换A盘</a> <?php endif; ?></span>
        </h1>
        <div class="mui-pull-right list_a">
            ...
            <!--<ul class="list_ul" style="z-index: 50">-->
                ...
                <!--<li><a href="<?php echo url('Report/openResult',array('cate_id'=>2)); ?>"> 开奖结果</a></li>-->
    ...
    <div class="mui-content">
        ...
        <div class="game_box2 padding_tb10 bor_bd7">
            <div class="clearfix ">
                <p class="left game_B2L cur_turn_num">20180927054期</p>
        ...
        <div class="game_box2 padding_tb10 bor_bd7">
            <div class="clearfix ">
                <p class="left game_B2L" id="next_turn_num">20180927054期</p>
    ...
    <div class="rule_box">
        <h4 class="mui-h4 mui-text-center mui-clearfix">重庆时时彩  <a class="mui-pull-right" href="javascript:void(0);"><img class="close" src="__IMG__/wap/close.png"/></a></h4>
        <p>
            重庆时时彩”是引进欧洲博彩公司开奖设备，由菲律宾博彩执照公司审核监控，联合开发的彩票游戏，保证公平公正；由于该彩种并不属于某单一地区彩种，
...
<script>
    ...
    var timeCountDown = {
        ...
        getTime:function (s,n) {
            $.ajax({
                url: "<?php echo url('Cqssc/getStage'); ?>",
                type: 'POST',
                dataType: "json",
        ...
        longPolling:function (stage) {
            ...
            $.ajax({
                url: "<?php echo url('Api/checkOpenCqSsc'); ?>",
                data: {stage: stage},
                type: 'POST',
                dataType: "json",
                timeout: 20000,//20秒超时，可自定义设置
