...
<div class="menu3"><a href="<?php echo url('Index/index'); ?>" class="logout">首页</a></div>
	...
	<div class="header-bottom sub">
		<div class="show cate_menu">
			<a href="<?php echo url('index',['cate'=>5,'hall'=>$hall]); ?>" class="router-link-exact-active selected">两面盘</a> |
			<a href="<?php echo url('index',['cate'=>5,'hall'=>$hall,'type'=>'two']); ?>" class="">单号1~10</a> |
			<a href="<?php echo url('index',['cate'=>5,'hall'=>$hall,'type'=>'three']); ?>" class="">冠亚组合</a>
			<?php if($hall==1): ?>
									...
									<div>
										<div class="cont-col3-bd">
											<table class="u-table2">
												<thead>
												<tr>
													<th colspan="12" data-target-type="13">冠、亚军和</th>
												</tr>
												</thead>
												<tbody>
												<tr>
													...
													<td class="name" data-num="<?php echo $vo['rule']; ?>"><?php echo $vo['rule']; ?></td>
													<td data-id="<?php echo $vo['id']; ?>" class="odds"><span class="c-txt3"><?php echo $vo['rate']; ?></span></td>
													<td class="amount"><input type="text" style="" /></td>
													<?php endforeach; endif; else: echo "" ;endif; ?>
												</tr>
												</tbody>
											</table>
												...
												<tr>
													...
													<td>
														<table class="u-table2">
															...
															<tr>
																<td data-id="<?php echo $v2['id']; ?>" class="name" data-num="<?php echo $v2['rule']; ?>"><?php echo $v2['rule']; ?></td>
																<td data-id="<?php echo $v2['id']; ?>" class="odds"><span class="c-txt3"><?php echo $v2['rate']; ?></span></td>
																<td data-id="<?php echo $v2['id']; ?>" class="amount"><input type="text" style="" /></td>
															</tr>
															<?php endforeach; endif; else: echo "" ;endif; ?>
															</tbody>
														</table></td>
