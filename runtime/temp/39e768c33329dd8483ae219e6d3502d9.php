<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/www/wwwroot/smgj/public/../app/admin/view/notice/system.html";i:1523368392;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li><a href="<?php echo url('system'); ?>">公告管理</a></li>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal form-post-addmoney" action="<?php echo url('add_system'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-lg-3 col-sm-3 control-label">公告标题</label>
                        <div class="col-lg-8">
                            <textarea name="title" rows="1" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
