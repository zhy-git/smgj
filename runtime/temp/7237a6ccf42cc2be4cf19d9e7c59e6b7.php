    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'nine']); ?>" class="router-link-exact-active selected">正码1~6</a> |
                                ...
                                <div>
                                    <div class="cont-col3-bd">
                                        <table class="cont-list1">
                                            <tbody>
                                            <tr>
                                                <?php if(is_array($rule_data['zmlm']) || $rule_data['zmlm'] instanceof \think\Collection || $rule_data['zmlm'] instanceof \think\Paginator): $i = 0; $__LIST__ = $rule_data['zmlm'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                                <td>
