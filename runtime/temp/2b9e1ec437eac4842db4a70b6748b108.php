<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/wwwroot/smgj/public/../app/home/view/agent/manageTeam.html";i:1540451213;s:63:"/www/wwwroot/smgj/public/../app/home/view/common/index_top.html";i:1540627555;s:68:"/www/wwwroot/smgj/public/../app/home/view/common/index_siderbar.html";i:1541410557;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
						...
						<div class="recharge_div active">
							...
							<form action="" id="searchForm">
								<div class="clearfix padding_10">
									...
									<div class="right">
										<a href="javascript:;" onclick='teamDetail(<?php echo session("member_info.uid"); ?>)' class="btn"> 团队总览</a>
									</div>
								</div>
							</form>
							<div class="table_box">
...
<script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == 1) {
                        ...
                        str += '<td>返点</td>';
                        str += '<td id="teamZl_rebate">' + data.data.back_rebate + '</td>';
                        str += '<td>注册时间</td>';
    ...
    function transferMoney(id){
        ...
        if(transferMoneyCheck) {
            ...
            $.post("<?php echo url('ransferMoney'); ?>", {id:id,money:money}, success, "json");
            return false;
            function success(data) {
                if (data.code == 1) {
                    pop(data.msg,"<?php echo url('Agent/index?type=manageTeam'); ?>");
                } else {
                    pop(data.msg);
                }
                setTimeout(function(){
