<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/www/wwwroot/smgj/public/../app/wap/view/account/tx_con.html";i:1540951274;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<body class="bg_ff">
		...
		<div class="mui-content">
			<div class="bank-info bg_ff">
				<div class="padding_10 ">
					...
					<span class="blue"><?php echo $title; ?></span>
				</div>
				<div class="padding_10 ">
					<label for="">到账账号</label>
					<span class="blue"><?php echo $card['num']; ?></span>
				</div>
				<div class="padding_10 ">
				...
				<div class="padding_10 bor_b">
					...
					<input type="number" name="money" id="" class="mui-h3" max-money="<?php echo $limit['cash_max_money']; ?>" min-money="<?php echo $limit['cash_min_money']; ?>" value="" />
				</div>
				<div class="padding_10 bor_b">
		...
		<script>
			...
			function cash() {
				...
				$.post("<?php echo url('cash'); ?>",{money:money,money_password:money_password,bank:money_password,way:way},function (data) {
					if(data.code==1){
                        layer.msg(data.msg, {
                            icon: 1,
