<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/www/wwwroot/smgj/public/../app/admin/view/rule/login_log.html";i:1523368392;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                ...
                <header class="panel-heading col-xs-12">
                    <form class="form-inline" action="<?php echo url(''); ?>">
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile" class="form-control" value="<?php echo isset($_GET['mobile']) ? $_GET['mobile'] :  ''; ?>" placeholder="请输入手机号码">
