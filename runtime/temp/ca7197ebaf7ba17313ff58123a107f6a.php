<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"/www/wwwroot/smgj/public/../app/wap/view/center/agent.html";i:1540630505;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="money-top">
				<dl class="clearfix">
					...
					<dd class="left padding_lr10">
						...
						<p class="color_ff mg_top10">账户余额：￥<span><?php echo bcadd($mem['money'],0,2); ?></span></p>
					</dd>
				</dl>
			</div>
			<ul class="clearfix agent-box bg_ff">
				<li><a href="<?php echo url('agent/team_page'); ?>"><img src="__IMG__/wap_new/team01.png" alt="" /><p>团队流水查询</p></a></li>
				<li><a href="<?php echo url('agent/agent_back'); ?>"><img src="__IMG__/wap_new/team02.png" alt="" /><p>团队返红记录</p></a></li>
				<li><a href="<?php echo url('agent/share'); ?>"><img src="__IMG__/wap_new/team03.png" alt="" /><p>分享二维码</p></a></li>
			</ul>
		</div>
