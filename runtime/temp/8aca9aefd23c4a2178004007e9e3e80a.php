<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/www/wwwroot/smgj/public/../app/admin/view/member/edit.html";i:1540178851;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="form">
                        <form class="form-horizontal adminex-form userForm"  method="post" action="<?php echo url('Member/edit'); ?>">
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">账号类型</label>
                                <i style="padding: 14px;">
                                    <input class="xb-icheck" type="radio" name="agent_user" id="agent_user2" value="1" <?php if(($info['is_proxy'] == 1)): ?>checked<?php endif; ?>/>
                                    <label for="agent_user">总代理</label>
                                </i>
                                <i style="padding: 14px;">
                                    <input class="xb-icheck" type="radio" name="agent_user" id="agent_user3" value="2" <?php if(($info['is_proxy'] == 2)): ?>checked<?php endif; ?>/>
                                    <label for="agent_user">一级代理</label>
                                </i>
                                <i style="padding: 14px;">
                                    <input class="xb-icheck" type="radio" name="agent_user" id="agent_user" value="3" <?php if(($info['is_proxy'] == 3)): ?>checked<?php endif; ?>/>
                                    <label for="agent_user">二级代理</label>
                                </i>
                                <i>
                                    <input class="xb-icheck" type="radio" name="agent_user" id="agent_user1" value="0" <?php if(($info['is_proxy'] == 0)): ?>checked<?php endif; ?>/>
                                    <label for="agent_user1">普通用户</label>
                                </i>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">是否允许转账</label>
                                <i style="padding: 14px;">
                                    <input class="xb-icheck" type="radio" name="is_tmoney" id="tmoney1" value="1" <?php if(($info['is_tmoney'] == 1)): ?>checked<?php endif; ?>/>
                                    <label for="tmoney1">允许</label>
                                </i>
                                <i>
                                    <input class="xb-icheck" type="radio" name="is_tmoney" id="tmoney0" value="0" <?php if(($info['is_tmoney'] == 0)): ?>checked<?php endif; ?>/>
                                    <label for="tmoney0">不允许</label>
                                </i>
                            </div>
                            <div class="form-group ">
                                <label class="control-label col-lg-2">账号</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="gm_name" value="<?php echo $info['gm_name']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="control-label col-lg-2">彩票返点</label>
                                <!--<select name="rebate" class="col-lg-6 form-control" style="margin-left: 14px;width: 200px;">-->
                                    <!--<?php if(is_array($rebate_list) || $rebate_list instanceof \think\Collection || $rebate_list instanceof \think\Paginator): $i = 0; $__LIST__ = $rebate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ll): $mod = ($i % 2 );++$i;?>-->
                                    <!--<option value="<?php echo $ll['rebate']; ?>,<?php echo $ll['bonus']; ?>" <?php if(($info['rebate'] == $ll['rebate'])): ?>selected<?php endif; ?>>返点：<?php echo $ll['rebate']; ?>  奖金：<?php echo $ll['bonus']; ?></option>-->
                                    <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
                                <!--</select>-->
                                <div class="col-lg-6">
                                    <input class=" form-control" name="back_rebate" value="<?php echo $info['back_rebate']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">用户电话</label>
                                <div class="col-lg-6">
                            ...
                            <!--</div>-->
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">用户QQ</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="qq" value="<?php echo $info['qq']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group " style="display: none">
                                <label  class="control-label col-lg-2">用户余额</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="money" value="<?php echo $info['money']; ?>" type="text" />
                                </div>
                            </div>

                            <div class="form-group ">
                                <label  class="control-label col-lg-2">真实姓名</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="true_name" value="<?php echo $info['true_name']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">用户备注</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="remark" value="<?php echo $info['remark']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">重置资金密码</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="remoney_password" value="" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">重置登陆密码</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="repassword" value="" type="text" />
                                </div>
                            </div>
                            <div class="form-group">
