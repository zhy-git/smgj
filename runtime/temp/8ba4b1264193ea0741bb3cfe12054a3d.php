    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'three']); ?>" class="router-link-exact-active selected">总肖、波色</a> |
                                    ...
                                    <div>
                                        <div class="cont-col3-bd">
                                            <table class="u-table2">
                                                <thead>
                                                <tr><th colspan="8">生肖</th></tr>
                                                <tr>
                                                    <th style="width: 4%;">生肖</th>
                                                    <th style="width: 30%;">号码</th>
                                                ...
                                                <tr data-target-type="1" data-target-num="总肖">
                                            ...
                                            <table class="u-table2 mt10">
                                                ...
                                                <tbody>
                                                <tr data-target-type="1" data-target-num="波色">
                                                    <?php if(is_array($rule_data['tmbs']) || $rule_data['tmbs'] instanceof \think\Collection || $rule_data['tmbs'] instanceof \think\Paginator): $i = 0; $__LIST__ = $rule_data['tmbs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                                    <td class="name" data-num="<?php echo $v1['rule']; ?>"><?php echo $v1['rule']; ?></td>
                                                    <td data-id="<?php echo $v1['id']; ?>" class="odds"><span class="c-txt3"><?php echo $v1['rate']; ?></span></td>
                                                    <td data-id="<?php echo $v1['id']; ?>" class="amount"><input type="text" /></td>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </tr>
