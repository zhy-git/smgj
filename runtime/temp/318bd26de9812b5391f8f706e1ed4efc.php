<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"/www/wwwroot/smgj/public/../app/wap/view/mssc/index.html";i:1541491905;s:61:"/www/wwwroot/smgj/public/../app/wap/view/common/bet_list.html";i:1523368392;s:57:"/www/wwwroot/smgj/public/../app/wap/view/common/menu.html";i:1523368392;s:53:"/www/wwwroot/smgj/public/../app/wap/view/mssc/js.html";i:1540865292;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main">
    <header class="mui-bar mui-bar-nav mui-clearfix">
        ...
        <h1 class="mui-title mui-pull-left">
            <span class="left">极速赛车<?php if($hall==1): ?> <a href="<?php echo url('index',['cate'=>6,'hall'=>2]); ?>" class="exchang">切换B盘</a> <?php else: ?> <a href="<?php echo url('index',['cate'=>6,'hall'=>1]); ?>" class="exchang">切换A盘</a> <?php endif; ?> </span>
        </h1>
        <div class="mui-pull-right list_a">
            ...
            <!--<ul class="list_ul" style="z-index: 50">-->
                ...
                <!--<li><a href="<?php echo url('Report/openResult',array('cate_id'=>8)); ?>"> 开奖结果</a></li>-->
    ...
    <div class="mui-content">
        ...
        <div class="game_box2 padding_tb10 bor_bd7">
            <div class="clearfix ">
                <p class="left game_B2L cur_turn_num">1809270891期</p>
        ...
        <div class="game_box2 padding_tb10 bor_bd7">
            <div class="clearfix ">
                <p class="left game_B2L" id="next_turn_num">1809270891期</p>
        ...
        <div class="game_box3 mui-clearfix">
            ...
            <div class="game_tab left">
                ...
                <div>
                    ...
                    <ul class="mui-clearfix three" data-target-type="<?php echo $vo['type']; ?>" data-target-num="<?php echo $vo['type_name']; ?>">
            ...
            <div class="tab_box">
                <div>
                    ...
                    <ul class="mui-clearfix two" data-target-type="<?php echo $vo['type']; ?>" data-target-num="<?php echo $vo['type_name']; ?>">
                        <?php if(is_array($vo['info']) || $vo['info'] instanceof \think\Collection || $vo['info'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['info'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                        <li data-num="<?php echo $v1['rule']; ?>"><a href="javascript:void(0);"><?php if(intval($v1['rule'])>=1): ?><span class="round2 rou bg<?php echo $v1['rule']; ?>"><?php echo $v1['rule']; ?></span><?php else: ?> <?php echo $v1['rule']; endif; ?><i data-id="<?php echo $v1['id']; ?>" class="odds"><?php echo $v1['rate']; ?></i></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div>
    ...
    <div class="rule_box">
        <h4 class="mui-h4 mui-text-center mui-clearfix">秒速赛车  <a class="mui-pull-right" href="javascript:void(0);"><img class="close" src="__IMG__/wap/close.png"/></a></h4>
        <p>
            秒速赛车”是引进欧洲博彩公司开奖设备，由菲律宾博彩执照公司审核监控，联合开发的彩票游戏，保证公平公正；由于该彩种并不属于某单一地区彩种，所以暂时还未对外开放官方网站，但是这类彩种在欧洲当地是非常火爆的，
                ...
                success: function (data, textStatus) {
                    if (data) {
                        if(s,n){
                            ...
                            $("#result-wrap i:eq(3)").html(lhhJudgment(parseInt(number[0]),parseInt(number[9])));
                            $("#result-wrap i:eq(4)").html(lhhJudgment(parseInt(number[1]),parseInt(number[8])));
                            $("#result-wrap i:eq(5)").html(lhhJudgment(parseInt(number[2]),parseInt(number[7])));
                            $("#result-wrap i:eq(6)").html(lhhJudgment(parseInt(number[3]),parseInt(number[6])));
                            $("#result-wrap i:eq(7)").html(lhhJudgment(parseInt(number[4]),parseInt(number[5])));
