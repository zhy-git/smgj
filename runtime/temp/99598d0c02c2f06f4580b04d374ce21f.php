<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:56:"/www/wwwroot/smgj/public/../app/home/view/car/three.html";i:1540433469;s:64:"/www/wwwroot/smgj/public/../app/home/view/common/detail_top.html";i:1539765119;s:62:"/www/wwwroot/smgj/public/../app/home/view/common/cate_top.html";i:1540435336;s:62:"/www/wwwroot/smgj/public/../app/home/view/common/siderbar.html";i:1539588229;s:62:"/www/wwwroot/smgj/public/../app/home/view/car/integration.html";i:1523368392;s:63:"/www/wwwroot/smgj/public/../app/home/view/car/integration2.html";i:1523368392;s:60:"/www/wwwroot/smgj/public/../app/home/view/common/footer.html";i:1540262035;s:53:"/www/wwwroot/smgj/public/../app/home/view/car/js.html";i:1540979980;}*/ ?>
<!DOCTYPE html>
<head>
...
<div class="menu3"><a href="<?php echo url('Index/index'); ?>" class="logout">首页</a></div>
	...
	<div class="header-bottom sub">
		<div class="show cate_menu">
			<a href="<?php echo url('index',['cate'=>5,'hall'=>$hall]); ?>" class="">两面盘</a> |
			<a href="<?php echo url('index',['cate'=>5,'hall'=>$hall,'type'=>'two']); ?>" class="">单号1~10</a> |
			<a href="<?php echo url('index',['cate'=>5,'hall'=>$hall,'type'=>'three']); ?>" class="router-link-exact-active selected">冠亚组合</a>
			<?php if($hall==1): ?>
			<a href="<?php echo url('index',['cate'=>5,'hall'=>2]); ?>" style="padding:2px 5px;background: green;border-radius: 5px;color: #fff;">切换B盘</a>
			<?php else: ?>
			<a href="<?php echo url('index',['cate'=>5,'hall'=>1]); ?>" style="padding:2px 5px;background: green;border-radius: 5px;color: #fff;">切换A盘</a>
			<?php endif; ?>
		</div>
	</div>
					...
					<div class="cont-main active">
						<div class="cont-col3">
							<div class="u-header play_tab_1 clearfix">
								<div class="fl">
									<span id="page_game_name">北京赛车(PK10)</span>&nbsp;&nbsp;-&nbsp;&nbsp;
									<span id="page_name">冠亚组合</span>
									...
									<div>
										<div class="cont-col3-bd">
											<table class="u-table2 play_tab_10">
												<thead>
												<tr>
													<th colspan="12" data-target-type="14">冠、亚军和数字</th>
												</tr>
												</thead>
												<tbody>
												...
												<tr>
													...
													<td data-id="<?php echo $v['id']; ?>" class="name" data-num="<?php echo $v['rule']; ?>"><?php echo $v['rule']; ?></td>
													<td data-id="<?php echo $v['id']; ?>" class="odds"><span class="c-txt3"><?php echo $v['rate']; ?></span></td>
													<td data-id="<?php echo $v['id']; ?>" class="amount"><input type="text" /></td>
													<?php endforeach; endif; else: echo "" ;endif; ?>
												</tr>
												<?php endforeach; endif; else: echo "" ;endif; ?>
												</tbody>
											...
											<table class="u-table2 play_tab_10">
												<thead>
												<tr>
													<th colspan="12" data-target-type="13">冠、亚军和两面</th>
												</tr>
												</thead>
												<tbody>
												<tr>
													<?php if(is_array($rule_data['gyhlm']) || $rule_data['gyhlm'] instanceof \think\Collection || $rule_data['gyhlm'] instanceof \think\Paginator): $i = 0; $__LIST__ = $rule_data['gyhlm'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
