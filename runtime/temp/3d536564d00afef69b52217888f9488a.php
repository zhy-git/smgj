    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'seventeen']); ?>" class="router-link-exact-active selected">连码</a> |
                ...
                <div class="cont-main active">
                    <div class="cont-col3">
                        <div class="u-header play_tab_1 clearfix">
                            <div class="fl"><span id="page_game_name">香港六合彩</span>&nbsp;&nbsp;-&nbsp;&nbsp;<span id="page_name">连码</span> <span id="total_sum_money_text">
                                &nbsp;&nbsp;
                                当前彩种输赢：<span id="total_sum_money">0.000</span></span>
                            </div>
                            <div class="fr"><span id="next_turn_num">2018006</span>&nbsp;期 距离封盘：
                                <span id="bet-date">1天 11:02:23</span> 距离开奖：
                                <span id="open-date">1天 11:07:23</span>
                            </div>
                        </div>
                        <div>
                            ...
                            <div id="betTable">
                                <div>
                                    ...
                                    <table class="u-table2 mt10">
                                        ...
                                        <?php $__FOR_START_844130390__=1;$__FOR_END_844130390__=50;for($j=$__FOR_START_844130390__;$j < $__FOR_END_844130390__;$j+=5){ ?>
                                        <tr data-target-type="<?php echo $vo['type']; ?>" data-target-num="<?php echo $vo['rule']; ?>" data-num="<?php echo $i; ?>">
                                            <?php $__FOR_START_176932842__=$j;$__FOR_END_176932842__=$j+5;for($i=$__FOR_START_176932842__;$i < $__FOR_END_176932842__;$i+=1){ if($i<=49): ?>
