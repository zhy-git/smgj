<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/wwwroot/smgj/public/../app/admin/view/rule/rule_group.html";i:1523368392;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <form action="" method="post"><input type="hidden" name="id" value="<?php echo $group_data['id']; ?>">
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <?php foreach($rule_data as $v): if(!$v['_data']): ?>
                    <tr class="b-group">
                        <th width="10%"><label><?php echo $v['title']; ?> <input type="checkbox" name="rule_ids[]" value="<?php echo $v['id']; ?>"
                    ...
                    <tr class="b-group">
                        ...
                        <td class="b-child">
                            ...
                            <table class="table table-striped table-bordered table-hover table-condensed">
                                <tr class="b-group">
                                    <th width="10%"><label><?php echo $n['title']; ?><input type="checkbox" name="rule_ids[]"
                                                                                value="<?php echo $n['id']; ?>"
                                                                                <?php if(in_array($v['id'],$group_data['rules'])): ?>checked="checked"<?php endif; ?>
                                        onclick="checkAll(this)"></label></th>
                                    <td>
                                        <?php if($n['_data']): foreach($n['_data'] as $c): ?><label>&emsp;<?php echo $c['title']; ?><input
                                            type="checkbox" name="rule_ids[]" value="<?php echo $c['id']; ?>"
                                            <?php if(in_array(($c['id']), is_array($group_data['rules'])?$group_data['rules']:explode(',',$group_data['rules']))): ?>
                                            checked="checked"
                                            <?php endif; ?>
