    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                ...
                <a href="<?php echo url('index',['cate'=>8,'hall'=>1,'type'=>'eleven']); ?>" class="router-link-exact-active selected">平特一肖/尾数</a> |
                                ...
                                <div>
                                    <div class="cont-col3-bd">
                                        <!--<ul class="tab" style="height: 35px;">-->
                                            <!--<li id="tm_tabs" class="tab_title02"><a href="javascript:void(0)" class="on">一肖</a><a href="javascript:void(0)" class="">尾数</a></li>-->
                                        <!--</ul>-->
                                        <table class="u-table2">
                                            <thead>
                                            <tr>
                                                <th colspan="8">平特一肖</th>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr data-target-type="30" data-target-num="平特一肖">
                                                ...
                                                <td class="name"><?php echo $v1['rule']; ?></td>
                                                <td data-id="<?php echo $v1['id']; ?>" data-num="<?php echo $v1['rule']; ?>" class="name">
                                                    <div class="qiu">
                                                        ...
                                                        <i class="lhc_icon mr1 lhc_b<?php echo $v2; ?>"><?php echo $v2; ?></i>
                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </div>
                                                </td>
                                        ...
                                        <table class="u-table2 mt10">
                                            <thead>
                                            <tr>
                                                <th colspan="15">平特尾数</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php if(is_array($rule_data['ptws']) || $rule_data['ptws'] instanceof \think\Collection || $rule_data['ptws'] instanceof \think\Paginator): $i = 0; $__LIST__ = $rule_data['ptws'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            <tr data-target-type="31" data-target-num="平特尾数">
                                                <?php if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                                <td data-num="<?php echo $v1['rule']; ?>尾" class="name"><?php echo $v1['rule']; ?>尾</td>
                                                <td data-id="<?php echo $v1['id']; ?>" class="odds"><span class="c-txt3"><?php echo $v1['rate']; ?></span></td>
                                                <td data-id="<?php echo $v1['id']; ?>" class="amount"><input type="text" /></td>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </tr>
