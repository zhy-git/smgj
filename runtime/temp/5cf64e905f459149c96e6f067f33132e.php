...
<div class="mui-inner-wrap mui-transitioning main">
	...
	<div class="mui-content">
		...
		<div class="game_box2 padding_tb10 bor_bd7">
			<div class="clearfix ">
				<p class="left game_B2L cur_turn_num">912345期</p>
		...
		<div class="game_box2 padding_tb10 bor_bd7">
			<div class="clearfix ">
				<p class="left game_B2L" id="next_turn_num">912345期</p>
		...
		<div class="game_box3 mui-clearfix">
			...
			<div class="game_tab left">
				<div class="tab_box active">
					...
					<!--<ul class="mui-clearfix three" data-target-type="1" data-target-num="混合">-->
						<!--<li data-num="极大"><a href="javascript:void(0);">极大<i data-id="64" class="odds"></i></a></li>-->
						<!--<li data-num="极小"><a href="javascript:void(0);">极小<i data-id="64" class="odds"></i></a></li>-->
						<!--<li data-num="豹子"><a href="javascript:void(0);">豹子<i data-id="65" class="odds"></i></a></li>-->
					<!--</ul>-->
				</div>
				<div class="tab_box">
					<h4 class="mui-text-center padding_10 bor_bd7">特码</h4>
					<ul class="mui-clearfix two" data-target-type="3" data-target-num="特码">
				...
				<div class="tab_box">
					...
					<ul class="mui-clearfix three" data-target-type="2" data-target-num="猜数字">
...
<script>
    ...
    var timeCountDown = {
        ...
        getTime:function (s,n) {
            $.ajax({
                url: "<?php echo url('Pcdd/getStage'); ?>",
                type: 'POST',
                dataType: "json",
        ...
        longPolling:function (stage) {
            ...
            $.ajax({
                url: "<?php echo url('Api/checkOpenPcdd'); ?>",
                data: {stage: stage},
                type: 'POST',
                dataType: "json",
                timeout: 20000,//20秒超时，可自定义设置
