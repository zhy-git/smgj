...
<div class="menu3"><a href="<?php echo url('Index/index'); ?>" class="logout">首页</a></div>
	...
	<div class="header-bottom sub">
		<div class="show cate_menu">
			...
			<a href="<?php echo url('index',['cate'=>6,'hall'=>$hall,'type'=>'two']); ?>" class="">单号1~10</a> |
			<a href="<?php echo url('index',['cate'=>6,'hall'=>$hall,'type'=>'three']); ?>" class="router-link-exact-active selected">冠亚组合</a>
			<?php if($hall==1): ?>
