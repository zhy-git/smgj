<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\money\transaction.html";i:1539395232;s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\base.html";i:1527061064;s:73:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-inline" action="<?php echo url('',array('id'=>$id)); ?>">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="exp">
                                ...
                                <?php if(is_array($detail_exp) || $detail_exp instanceof \think\Collection || $detail_exp instanceof \think\Paginator): $i = 0; $__LIST__ = $detail_exp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$del): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $del['id']; ?>" <?php if((isset($_GET['exp']) && $_GET['exp'] == $del['id'])): ?>selected<?php endif; ?>><?php echo $del['name']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
