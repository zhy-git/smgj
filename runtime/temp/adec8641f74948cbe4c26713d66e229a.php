    ...
    <a href="<?php echo url('Msssc/index',['cate'=>4,'hall'=>1]); ?>"  <?php if($controllerName == 'msssc'): ?>class="selected"<?php endif; ?>><span>极速时时彩</span> <i class="editbtn" style="display: none;"></i></a>
        ...
        <div class="header-bottom sub">
            <div class="show cate_menu">
                <a href="<?php echo url('index',['cate'=>3,'hall'=>$hall]); ?>" class="">整合</a> |
                <a href="<?php echo url('index',['cate'=>3,'hall'=>$hall,'type'=>'ball']); ?>" class="router-link-exact-active selected">1~5</a> |
                <?php if($hall==1): ?>
                <a href="<?php echo url('index',['cate'=>3,'hall'=>2]); ?>" style="padding:2px 5px;background: green;border-radius: 5px;color: #fff;">切换B盘</a>
                <?php else: ?>
                <a href="<?php echo url('index',['cate'=>3,'hall'=>1]); ?>" style="padding:2px 5px;background: green;border-radius: 5px;color: #fff;">切换A盘</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
                    ...
                    <div class="cont-main active">
                        <div class="cont-col3">
                            <div class="u-header play_tab_1 clearfix">
                                <div class="fl">
                                    <span id="page_game_name">重庆时时彩</span>&nbsp;&nbsp;-&nbsp;&nbsp;
                                    <span id="page_name">1-5球</span>
