<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\lottery\lhc_stage_add.html";i:1537259562;s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\base.html";i:1527061064;s:73:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td><?php echo $vo['number']?$vo['number']:'未开奖'; ?></td>
                                    <td>
                                        <a onclick="opens('<?php echo $vo['id']; ?>','<?php echo $vo['stage']; ?>','<?php echo $vo['end_time']; ?>',this)" class="fa confirm"  title="开奖">开奖</a>
                                        <a href="<?php echo url('lottery/lhc_stage_del',['id'=>$vo['id']]); ?>" class="fa fa-times confirm "  title="删除"></a>
                                    </td>
                                </tr>
