<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/home\view\index\agree.html";i:1539593194;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>生米国际</title>
        <link href="__CSS__/agreement.css" rel="stylesheet" type="text/css">
    </head> 
    <body class="skin_blue" style="background:#5a8fd4 !important">
        <div class="user_win">
            <div class="agree_win"> 
                    ...
                    <li class="user_winmain">
                        <div class="win_info">
                            <ul>
                                ...
                                <li class="user_winbu"><div><span><a class="yes" href="<?php echo url('index/index'); ?>" id="yesBtn">同意</a><a class="no" href="<?php echo url('login/out'); ?>">不同意</a></span></div></li>
                            </ul>
                        </div>
                    </li>
