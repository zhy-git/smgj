<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/www/wwwroot/smgj/public/../app/admin/view/rule/add_admin.html";i:1523368392;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <tr>
                        ...
                        <td>
                            <?php foreach($data as $v): ?> <?php echo $v['title']; ?> <input class="xb-icheck" type="checkbox" name="group_ids[]"
                                                                       value="<?php echo $v['id']; ?>"> &emsp;<?php endforeach; ?>
                        </td>
                    </tr>
                    <tr>
                        <th>姓名</th>
                    ...
                    <tr>
                        ...
                        <td><span class="inputword ">允许登录</span> <input class="xb-icheck" type="radio" name="status" value="1"
                                                                        checked="checked"> &emsp; <span class="inputword ">禁止登录</span>
