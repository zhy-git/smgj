<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/www/wwwroot/smgj/public/../app/admin/view/money/back_water.html";i:1540288704;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-inline" action="<?php echo url(''); ?>">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="exp">
                                <option value="0">方式</option>
                                <option value='6' <?php if((isset($_GET['exp']) && $_GET['exp'] == 6)): ?>selected<?php endif; ?>>返利</option>
                                <option value="11" <?php if((isset($_GET['exp']) && $_GET['exp'] == 11)): ?>selected<?php endif; ?>>投注回水</option>
                                <option value='12' <?php if((isset($_GET['exp']) && $_GET['exp'] == 12)): ?>selected<?php endif; ?> >代理返水</option>
                            </select>
                            <input type="text" name="gm_name" class="form-control" placeholder="请输入账号">
                    ...
                    <form class="ids" action="<?php echo url(''); ?>" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php if($v['exp']==11): ?>投注回水<?php elseif($v['exp']==12): ?>代理返水<?php elseif($v['exp']==6): ?>返利<?php endif; ?></td>
                                <td><?php if((isTimeZero($v['create_at']))): ?><?php echo $v['create_at']; endif; ?></td>
                                <td><?php echo $v['explain']; ?></td>
                                <td><?php if($v['status']==1): ?>待审核<?php elseif($v['status']==2): ?>审核成功<?php elseif($v['status']==3): ?>审核失败<?php endif; ?></td>
                                <td>
                                    <?php if(($v['status'] == 1)): ?>
                                    <a href="#"   class="btn btn-success ajax-get" onclick="shenhe(1,'<?php echo $v['uid']; ?>','<?php echo $v['id']; ?>')" title="审核">通过</a>
                                    <a href="#"  class="btn btn-danger ajax-get" onclick="shenhe(2,'<?php echo $v['uid']; ?>','<?php echo $v['id']; ?>')" title="审核">不通过</a>
...
<script type="text/javascript">
    ...
    function shenhe(type,uid,id) {
        $.ajax({
            type: "post",
            url: "<?php echo url('edit_water_status'); ?>",
