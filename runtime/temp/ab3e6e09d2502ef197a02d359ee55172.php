<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\money\team_detail.html";i:1540609782;s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\base.html";i:1527061064;s:73:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="ids" action="<?php echo url(''); ?>" method="post">
                        <table class="table" style="text-align: center">
                            ...
                            <tr style="background:rosybrown;">
                                <td >账号</td>
                                <td ><?php echo (isset($mem['gm_name']) && ($mem['gm_name'] !== '')?$mem['gm_name']:"平台"); ?></td>
                                <td>团队余额</td>
                                <td><?php echo (isset($mem['teamMoney']) && ($mem['teamMoney'] !== '')?$mem['teamMoney']:'0.00'); ?></td>
                            </tr>
                            <tr style="background: darkslateblue">
                                <td>团队人数</td>
                                <td><?php echo (isset($mem['teamNum']) && ($mem['teamNum'] !== '')?$mem['teamNum']:'0'); ?></td>
                                <td>在线人数</td>
                                <td><?php echo (isset($mem['onlineNum']) && ($mem['onlineNum'] !== '')?$mem['onlineNum']:'0'); ?></td>
                            </tr>
                            <tr style="background: darkslategray">
                                <td>团队充值</td>
                                <td><?php echo (isset($mem['teamRecharge']) && ($mem['teamRecharge'] !== '')?$mem['teamRecharge']:'0.00'); ?></td>
                                <td>团队提现</td>
                                <td><?php echo (isset($mem['teamCash']) && ($mem['teamCash'] !== '')?$mem['teamCash']:'0.00'); ?></td>
                            </tr>
                            <tr style="background: plum">
                                <td>团队投注</td>
                                <td><?php echo (isset($mem['teamBet']) && ($mem['teamBet'] !== '')?$mem['teamBet']:'0.00'); ?></td>
                                <td>团队中奖</td>
                                <td><?php echo (isset($mem['teamWin']) && ($mem['teamWin'] !== '')?$mem['teamWin']:'0.00'); ?></td>
                            </tr>
                            <tr style="background: goldenrod">
                                <td>团队返利</td>
                                <td><?php echo (isset($mem['teamFan']) && ($mem['teamFan'] !== '')?$mem['teamFan']:'0.00'); ?></td>
                                <td>团队盈亏（用户角度）</td>
                                <td><?php echo (isset($mem['teamYk']) && ($mem['teamYk'] !== '')?$mem['teamYk']:'0.00'); ?></td>
                            </tr>
                            <!--<tr style="background: plum">-->
                            <!--<td>总上分</td>-->
                            <!--<td><?php echo (isset($up_total) && ($up_total !== '')?$up_total:'0.00'); ?></td>-->
                            <!--<td>总下分</td>-->
                            <!--<td><?php echo (isset($down_total) && ($down_total !== '')?$down_total:'0.00'); ?></td>-->
                            <!--</tr>-->
                            <!--<tr style="background: goldenrod">-->
                            <!--<td>总回水</td>-->
                            <!--<td><?php echo (isset($back_total) && ($back_total !== '')?$back_total:'0.00'); ?></td>-->
                            <!--<td>总流水</td>-->
                            <!--<td><?php echo (isset($flow_total) && ($flow_total !== '')?$flow_total:'0.00'); ?></td>-->
                            <!--<td>总代理回水</td>-->
                            <!--<td><?php echo (isset($d_back_total) && ($d_back_total !== '')?$d_back_total:'0.00'); ?></td>-->
                            <!--</tr>-->
                            </tbody>
                        </table>
                    </form>
