<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/wwwroot/smgj/public/../app/admin/view/member/zfb_edit.html";i:1540952896;s:59:"/www/wwwroot/smgj/public/../app/admin/view/common/base.html";i:1527061064;s:58:"/www/wwwroot/smgj/public/../app/admin/view/common/nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="form">
                        <form class="form-horizontal adminex-form userForm"  method="post" action="<?php echo url(''); ?>">
                            ...
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">帐号</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="num" value="<?php echo $info['num']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">支付宝昵称</label>
                                <div class="col-lg-6">
