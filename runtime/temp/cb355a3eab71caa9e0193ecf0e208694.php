<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\member\bank.html";i:1523368392;s:74:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\base.html";i:1527061064;s:73:"E:\phpStudy\PHPTutorial\WWW\smgj\public/../app/admin\view\common\nav.html";i:1523368392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <section class="panel">
                    <header class="panel-heading col-xs-12">
                        <form class="ids form-inline" action="<?php echo url(''); ?>" method="post">
                            <div class="form-group">
                                <input type="text" name="gm_name" class="form-control" value="<?php echo isset($_GET['gm_name']) ? $_GET['gm_name'] :  ''; ?>" placeholder="请输入昵称">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo url('bank_edit',['id'=>$v['id']]); ?>">修改</a></td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
