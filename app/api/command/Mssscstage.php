...
class Mssscstage extends Command
{
    protected function configure()
    {
        $this->setName('mssscstage')->setDescription('秒速时时彩期数生成');
    }
    ...
    public function doCron(){
        ...
        $is = Db::name('msssc_stage')->where($whereData)->value('id');
        if(!$is) {
            ...
            Db::name('msssc_stage')->insertAll($insertData);
        }
    }
}