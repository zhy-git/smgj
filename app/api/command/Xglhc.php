...
//                                $returnData = xglhcLm($v['number'], $number_arr);
                            ...
                            case 38://特串
                                ...
                                break;
//                            case 3://色波
//                                $returnData = xglhcSb($v['number'], $number_arr);
//                                break;
//                            case 4://特肖
//                                $returnData = xglhcTx($v['number'], $number_arr);
//                                break;
//                            case 5://特码头尾数
//                                $returnData = xglhcTmtws($v['number'], $number_arr);
//                                break;
//                            case 6://正码
//                                $returnData = xglhcZm($v['number'], $number_arr);
//                                break;
...
//                            case 17://正五
//                            case 18://正六
//                                $returnData = xglhcZmnum($v['number'], $number_arr,$v['type']);
//                                break;
//                            case 19://五行
//                                $returnData = xglhcWx($v['number'], $number_arr);
//                                break;
//                            case 20://平特一肖尾数
//                                $returnData = xglhcPtyxws($v['number'], $number_arr);
//                                break;
//                            case 21://正肖
//                                $returnData = xglhcZx($v['number'], $number_arr);
//                                break;
//                            case 22://七色波
//                                $returnData = xglhcQsb($v['number'], $number_arr);
//                                break;
//                            case 23://总肖
//                                $returnData = xglhcZongx($v['number'], $number_arr);
//                                break;
                        }
                        if ($returnData['win']) {
                            if($returnData['win'] == 2){
