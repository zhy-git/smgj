...
class Member extends Validate
{
    protected $rule = [
        ...
        'moneypassword' =>  'require|min:6|max:6|stringCheck',
        'repassword' =>  'require|confirm:password',
        'rebate' => 'require',
        'back_rebate'=>'require',
        'agent_user' => 'require|integer|between:0,3',
    ...
    protected $message = [
        ...
        'moneypassword.require' =>  '请输入密码',
        'moneypassword.min' =>  '密码长度6',
        'moneypassword.max' =>  '密码长度6',
        'moneypassword.stringCheck' => '密码只能包含英文、数字、下划线',
    ...
    protected $scene = [
        'add'   =>  ['username','password','repassword','back_rebate','agent_user'],
        'add_link'   =>  ['back_rebate','agent_user','remark'],
        'link_reg'   =>  ['username','password','moneypassword'],
